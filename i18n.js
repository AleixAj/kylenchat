...
(function (root) {
  const STRINGS = {
    es: {
      ...
      tabGeneral: 'General',
      tabGames: 'Juegos',
      sectionGames: 'Estilos de juegos',
      gamesNote: 'El chat con el aspecto del de cada juego: su letra, sus colores y su formato. Elige uno y ajústalo abajo.',
      game_wow: 'Estilo WoW',
      game_lol: 'Estilo LoL',
      game_valorant: 'Estilo Valorant',
      game_minecraft: 'Estilo Minecraft',
      gameActive: '✓ En uso',
      gamePreviewLines: 'Kylen~broadcaster~¡Bienvenidos al directo!|Moderadora~moderator~Recordad ser respetuosos|Pepita_22~subscriber~¿qué build llevas?',
      gamePreviewNotice: 'Thrall se ha suscrito. ¡Lleva 6 meses!',
      sectionGameOptions: 'Personalizar',
      gameNoneNote: 'Elige un estilo de juego para personalizarlo.',
      gameNames: 'Colores de los nombres',
      gameNamesGame: 'Los del juego',
      gameNamesTwitch: 'Los de Twitch',
      gameTag: 'Etiqueta del canal',
      gameTagNone: 'sin etiqueta',
      gameOff: 'Quitar el estilo de juego',
      gamesDisclaimer: 'Inspirados en World of Warcraft, League of Legends, Valorant y Minecraft. No están afiliados a Blizzard, Riot Games ni Mojang: las fuentes son libres y parecidas a las originales, y los detalles están dibujados por la app.',
      themeTag_wow: '',
    ...
    en: {
      ...
      tabGeneral: 'General',
      tabGames: 'Games',
      sectionGames: 'Game styles',
      gamesNote: 'Your chat with the look of each game\'s chat: its font, colors and format. Pick one and tweak it below.',
      game_wow: 'WoW style',
      game_lol: 'LoL style',
      game_valorant: 'Valorant style',
      game_minecraft: 'Minecraft style',
      gameActive: '✓ In use',
      gamePreviewLines: 'Kylen~broadcaster~Welcome to the stream!|Moderator~moderator~Please be respectful|Penny_22~subscriber~what build are you running?',
      gamePreviewNotice: 'Thrall subscribed. They\'ve subscribed for 6 months!',
      sectionGameOptions: 'Customize',
      gameNoneNote: 'Pick a game style to customize it.',
      gameNames: 'Name colors',
      gameNamesGame: 'The game\'s',
      gameNamesTwitch: 'Twitch\'s',
      gameTag: 'Channel tag',
      gameTagNone: 'no tag',
      gameOff: 'Remove the game style',
      gamesDisclaimer: 'Inspired by World of Warcraft, League of Legends, Valorant and Minecraft. Not affiliated with Blizzard, Riot Games or Mojang: the fonts are free lookalikes and the details are drawn by the app.',
      themeTag_wow: '',
  ...
  const CHANGELOG = {
    es: {
      '1.4.0': [
        'Estilos de juegos (pestaña Juegos): el chat con el aspecto del de WoW, LoL, Valorant o Minecraft, con su letra, sus colores, su formato y sus detalles. Se pueden personalizar.',
      ],
      '1.3.2': [
    ...
    en: {
      '1.4.0': [
        'Game styles (Games tab): your chat with the look of WoW, LoL, Valorant or Minecraft, with their font, colors, format and details. They can be customized.',
      ],
      '1.3.2': [
