...
(function (root) {
  const STRINGS = {
    es: {
      ...
      gameActive: '✓ En uso',
      gamePreviewLines: 'Anita~broadcaster~¡Bienvenidos al directo!|Kylen~moderator~Recordad ser respetuosos|Kurkya~~¿qué build llevas?',
      gamePreviewNotice: 'Kurkya se ha suscrito. ¡Lleva 6 meses!',
    ...
    en: {
      ...
      gameActive: '✓ In use',
      gamePreviewLines: 'Anita~broadcaster~Welcome to the stream!|Kylen~moderator~Please be respectful|Kurkya~~what build are you running?',
      gamePreviewNotice: 'Kurkya subscribed. They\'ve subscribed for 6 months!',
