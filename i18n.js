...
(function (root) {
  const STRINGS = {
    es: {
      ...
      game_cs2: 'Estilo CS2',
      game_overwatch: 'Estilo Overwatch 2',
      game_fortnite: 'Estilo Fortnite',
      game_rust: 'Estilo Rust',
      themeTag_cs2: 'TODOS',
      themeTag_overwatch: 'Partida',
      themeTag_fortnite: '',
      themeTag_rust: 'Global',
      cs2Say: 'Decir a todos',
      cs2Send: 'ENVIAR',
      owHint: 'PULSA TAB PARA CAMBIAR DE CANAL',
      fnHint: 'Pulsa Intro para chatear',
      gameDecor: 'Detalles del juego',
      gameDecorNote: 'botones, pestañas y casilla de escribir',
      gameActive: '✓ En uso',
    ...
    en: {
      ...
      game_cs2: 'CS2 style',
      game_overwatch: 'Overwatch 2 style',
      game_fortnite: 'Fortnite style',
      game_rust: 'Rust style',
      themeTag_cs2: 'ALL',
      ...
      cs2Say: 'Say to all',
      cs2Send: 'SEND',
      owHint: 'PRESS TAB TO CYCLE CHANNELS',
      fnHint: 'Press Enter to chat',
      gameDecor: 'Game details',
      gameDecorNote: 'buttons, tabs and input box',
      gameActive: '✓ In use',
      ...
      gamesDisclaimer: 'Inspired by World of Warcraft, League of Legends, Valorant, Minecraft, Counter-Strike 2, Overwatch 2, Fortnite and Rust. Not affiliated with their makers (Blizzard, Riot Games, Mojang, Valve, Epic Games or Facepunch): the fonts are free lookalikes and the details are drawn by the app.',
      themeTag_wow: '',
