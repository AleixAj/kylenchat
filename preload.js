...
contextBridge.exposeInMainWorld('api', {
  ...
  addChat: (channel) => ipcRenderer.send('add-chat', channel),
  removeChat: (id) => ipcRenderer.send('remove-chat', id),
  setChatVisible: (id, on) => ipcRenderer.send('set-chat-visible', id, on),
