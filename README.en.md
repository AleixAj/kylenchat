...
In the **Alerts** tab, type a channel (or paste its twitch.tv link) and click **Add**. Channels that are live right now show a red dot. The app checks every 30 seconds by asking Twitch directly, with a lightweight request, without logging in to Twitch.
