...
A la pestanya **Avisos** escriu un canal (o enganxa'n l'enllaç de twitch.tv) i prem **Añadir** (Afegeix). Els que són en directe en aquell moment surten amb un punt vermell. L'app ho comprova cada minut preguntant directament a Twitch, amb una consulta lleugera, sense iniciar sessió a Twitch.
